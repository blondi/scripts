...
#HOSTNAME
echo ${bold}SETTING UP HOSTNAME...
hostname="arch"
echo $hostname >> /etc/hostname
echo -e "127.0.1.1\t $hostname.localdomain $hostname" >> /etc/hosts

#LOCALE
echo ${bold}SETTING UP LOCALE...
...
#SCRIPTS
echo ${bold}MOVING SCRIPTS...
cp -r /root/scripts /home/blondi/

#SYS INFO
echo ${bold}COLLECTING INFO...
...
#SYSTEMD BOOT
echo ${bold}SETTING UP SYSTEMD BOOT...
